...
def _main():
    ...
    while True:
        ...
        faces = post_process(frame, outs, CONF_THRESHOLD, NMS_THRESHOLD) #in utils
    ...
    print('==> All done!')
    print('***********************************************************')
    folder1 = r"D:\PycharmProject\yoloface\cropped_images"
    folder2 = r"D:\PycharmProject\yoloface\main_database"
    
    # Change this line to specify the correct CSV file path
    csv_file = r"./attendence.CSV"
